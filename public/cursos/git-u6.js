...
pasos:[
 ...
 {t:"info", eti:"Flujo 1", h:"GitHub Flow: el más simple y el más usado",
  c:`<div class="dg"><div class="dg-tit">github flow</div>
<svg viewBox="0 0 350 138" width="100%" style="max-width:460px;display:block;margin:auto" role="img" aria-label="main siempre desplegable; ramas de feature cortas que salen de main y vuelven con un PR"><defs><marker id="fl-git6-1" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="7" markerHeight="7" orient="auto-start-reverse"><path d="M0 0L10 5L0 10z" fill="var(--accent)"/></marker></defs><text x="8" y="49" text-anchor="start" font-size="12" font-family="var(--mono)" fill="var(--accent)" font-weight="700">main</text><line x1="55" y1="45" x2="330" y2="45" stroke="var(--accent)" stroke-width="2" marker-end="url(#fl-git6-1)"/><polyline points="55,45 85,95 115,95 140,45" fill="none" stroke="var(--line-2)" stroke-width="2"/><polyline points="140,45 170,95 200,95 230,95 255,45" fill="none" stroke="var(--line-2)" stroke-width="2"/><circle cx="55" cy="45" r="8" fill="var(--accent)" stroke="var(--accent)" stroke-width="2"/><circle cx="140" cy="45" r="8" fill="var(--accent)" stroke="var(--accent)" stroke-width="2"/><circle cx="255" cy="45" r="8" fill="var(--accent)" stroke="var(--accent)" stroke-width="2"/><circle cx="305" cy="45" r="8" fill="var(--accent)" stroke="var(--accent)" stroke-width="2"/><circle cx="85" cy="95" r="8" fill="var(--bg)" stroke="var(--accent)" stroke-width="2"/><circle cx="115" cy="95" r="8" fill="var(--bg)" stroke="var(--accent)" stroke-width="2"/><circle cx="170" cy="95" r="8" fill="var(--bg)" stroke="var(--accent)" stroke-width="2"/><circle cx="200" cy="95" r="8" fill="var(--bg)" stroke="var(--accent)" stroke-width="2"/><circle cx="230" cy="95" r="8" fill="var(--bg)" stroke="var(--accent)" stroke-width="2"/><text x="345" y="22" text-anchor="end" font-size="12" font-family="var(--sans)" fill="var(--ink-3)">(siempre desplegable)</text><text x="175" y="128" text-anchor="middle" font-size="12" font-family="var(--sans)" fill="var(--ink-2)">ramas de feature cortas + PR</text></svg></div>
 ...
 {t:"info", eti:"Flujo 2", h:"Git Flow: para versiones planificadas",
  c:`<div class="dg"><div class="dg-tit">git flow</div>
<svg viewBox="0 0 350 214" width="100%" style="max-width:460px;display:block;margin:auto" role="img" aria-label="main solo con versiones publicadas; develop para integrar; feature/x sale de develop y vuelve; release/1.2 sale de develop y se fusiona en main y develop; hotfix sale de main y vuelve a main y develop"><defs><marker id="fl-git6-2" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="7" markerHeight="7" orient="auto-start-reverse"><path d="M0 0L10 5L0 10z" fill="var(--accent)"/></marker></defs><text x="8" y="34" text-anchor="start" font-size="12" font-family="var(--mono)" fill="var(--accent)" font-weight="700">main</text><text x="8" y="69" text-anchor="start" font-size="12" font-family="var(--mono)" fill="var(--ink-2)">hotfix/...</text><text x="8" y="104" text-anchor="start" font-size="12" font-family="var(--mono)" fill="var(--ink-2)">release/1.2</text><text x="8" y="139" text-anchor="start" font-size="12" font-family="var(--mono)" fill="var(--ink)" font-weight="700">develop</text><text x="8" y="174" text-anchor="start" font-size="12" font-family="var(--mono)" fill="var(--ink-2)">feature/x</text><line x1="110" y1="30" x2="340" y2="30" stroke="var(--accent)" stroke-width="2"/><line x1="125" y1="135" x2="340" y2="135" stroke="var(--ink-3)" stroke-width="2"/><polyline points="110,30 125,135" fill="none" stroke="var(--line-2)" stroke-width="2"/><polyline points="150,135 170,170 188,170 205,135" fill="none" stroke="var(--line-2)" stroke-width="2"/><polyline points="225,135 250,100 280,30" fill="none" stroke="var(--line-2)" stroke-width="2"/><polyline points="250,100 280,135" fill="none" stroke="var(--line-2)" stroke-width="2"/><polyline points="280,30 310,65 340,30" fill="none" stroke="var(--line-2)" stroke-width="2"/><polyline points="310,65 340,135" fill="none" stroke="var(--line-2)" stroke-width="2"/><circle cx="110" cy="30" r="7" fill="var(--accent)" stroke="var(--accent)" stroke-width="2"/><circle cx="280" cy="30" r="7" fill="var(--accent)" stroke="var(--accent)" stroke-width="2"/><circle cx="340" cy="30" r="7" fill="var(--accent)" stroke="var(--accent)" stroke-width="2"/><circle cx="125" cy="135" r="7" fill="var(--bg-3)" stroke="var(--accent)" stroke-width="2"/><circle cx="150" cy="135" r="7" fill="var(--bg-3)" stroke="var(--accent)" stroke-width="2"/><circle cx="205" cy="135" r="7" fill="var(--bg-3)" stroke="var(--accent)" stroke-width="2"/><circle cx="225" cy="135" r="7" fill="var(--bg-3)" stroke="var(--accent)" stroke-width="2"/><circle cx="280" cy="135" r="7" fill="var(--bg-3)" stroke="var(--accent)" stroke-width="2"/><circle cx="340" cy="135" r="7" fill="var(--bg-3)" stroke="var(--accent)" stroke-width="2"/><circle cx="170" cy="170" r="7" fill="var(--bg)" stroke="var(--accent)" stroke-width="2"/><circle cx="188" cy="170" r="7" fill="var(--bg)" stroke="var(--accent)" stroke-width="2"/><circle cx="250" cy="100" r="7" fill="var(--bg)" stroke="var(--accent)" stroke-width="2"/><circle cx="310" cy="65" r="7" fill="var(--bg)" stroke="var(--accent)" stroke-width="2"/><text x="175" y="205" text-anchor="middle" font-size="12" font-family="var(--sans)" fill="var(--ink-3)">main: solo versiones publicadas · develop: integración</text></svg></div>
...
pasos:[
 {t:"info", eti:"El caso", h:"Quieres mejorar un proyecto que no es tuyo",
  c:`<p>No tienes permisos para hacer push al repositorio de otra persona u organización. La solución es un <b>fork</b>: una copia del repositorio <b>en tu cuenta de GitHub</b>, donde sí puedes hacer lo que quieras.</p>
     <div class="dg"><div class="dg-tit">del original a tu portátil</div>
<svg viewBox="50 0 265 232" width="100%" style="max-width:340px;display:block;margin:auto" role="img" aria-label="empresa/libreria, el original o upstream; con Fork se crea pablo/libreria, tu fork u origin; con git clone llega a tu portátil"><defs><marker id="fl-git6-3" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="7" markerHeight="7" orient="auto-start-reverse"><path d="M0 0L10 5L0 10z" fill="var(--accent)"/></marker></defs><rect x="60" y="5" width="200" height="44" rx="8" fill="var(--bg-3)" stroke="var(--line-2)" stroke-width="1.5"/><text x="160" y="22.5" text-anchor="middle" font-size="12" font-family="var(--mono)" fill="var(--ink)" font-weight="700">empresa/libreria</text><text x="160" y="39.5" text-anchor="middle" font-size="12" font-family="var(--sans)" fill="var(--ink-2)">(original, «upstream»)</text><line x1="160" y1="53" x2="160" y2="95" stroke="var(--accent)" stroke-width="1.5" marker-end="url(#fl-git6-3)"/><text x="172" y="78" text-anchor="start" font-size="12" font-family="var(--sans)" fill="var(--accent)">Fork (botón en GitHub)</text><rect x="60" y="99" width="200" height="44" rx="8" fill="var(--accent-soft)" stroke="var(--accent)" stroke-width="1.5"/><text x="160" y="116.5" text-anchor="middle" font-size="12" font-family="var(--mono)" fill="var(--accent)" font-weight="700">pablo/libreria</text><text x="160" y="133.5" text-anchor="middle" font-size="12" font-family="var(--sans)" fill="var(--ink-2)">(tu fork, «origin»)</text><line x1="160" y1="147" x2="160" y2="189" stroke="var(--accent)" stroke-width="1.5" marker-end="url(#fl-git6-3)"/><text x="172" y="172" text-anchor="start" font-size="12" font-family="var(--mono)" fill="var(--accent)">git clone</text><rect x="60" y="193" width="200" height="34" rx="8" fill="var(--bg)" stroke="var(--line-2)" stroke-width="1.5"/><text x="160" y="214" text-anchor="middle" font-size="12" font-family="var(--sans)" fill="var(--ink)" font-weight="700">tu portátil</text></svg></div>`},
